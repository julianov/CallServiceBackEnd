    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location_lat', models.FloatField(blank=True, default=None)),
                ('location_long', models.FloatField(blank=True, default=None)),
                ('day', models.DateField(blank=True, default=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('proveedor_company', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='callserviceapp.company')),
                ('proveedor_independiente', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='callserviceapp.serviceprovider')),
            ],
        ),
        migrations.CreateModel(
            name='order',
            fields=[
                ...
                ('orden_emergencia', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.CASCADE, to='callserviceapp.ordenemergencia')),
                ('orden_general', models.ForeignKey(blank=True, db_constraint=False, default=None, on_delete=django.db.models.deletion.CASCADE, to='callserviceapp.ordengeneral')),
                ('proveedor', models.ForeignKey(db_constraint=False, default=None, on_delete=django.db.models.deletion.CASCADE, to='callserviceapp.proveedor')),
            ],
        ),
        migrations.AddField(
